      ...
      <header className="bg-surface border-b border-border">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="font-semibold">Share Invoice</h1>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="card mb-6">
            <div className="text-sm text-muted mb-2 text-left">Payment Link</div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            ...
            >
              <svg className="w-6 h-6 mx-auto mb-2 text-muted" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Invoice ready for payment: ${payLink}`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="card hover:border-primary/30 transition-colors py-4"
            >
